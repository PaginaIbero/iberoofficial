...
export function YearCard({ id }: {
  ...
  return (
    <div className='flex flex-col justify-center items-center bg-blue-50 hover:bg-blue-100 transition-colors h-40 md:w-1/4 p-6 rounded-3xl border border-blue-200 shadow-sm'>
      <h1 className='text-4xl font-semibold text-blue-800 mb-3'>{id}</h1>
      <Link
...
export function VerMasCard() {
  return (
    <div className='flex flex-col justify-center items-center bg-blue-100 hover:bg-blue-200 transition-colors h-40 md:w-1/4 p-6 rounded-3xl border border-blue-300 shadow-sm'>
      <Link 
